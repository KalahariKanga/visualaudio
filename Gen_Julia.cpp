...
{
	float jx = Math::lint(getParameter("minX")->getValue(), getParameter("maxX")->getValue(), ac->getAmplitude());
	float jy = Math::lint(getParameter("minY")->getValue(), getParameter("maxY")->getValue(), ac->getAmplitude());
